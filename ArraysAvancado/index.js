...
// de uma forma um pouco mais extensa 
// para separar melhor as partes do código:
...
// Vendo o código acima, percebe-se melhor onde começam e terminam cada um dos 
// parâmetros do reduce(): o primeiro parâmetro, uma função e o segundo, um número.

// Uma terceira forma de reescrever 
// seria escrevendo a função callback fora do reduce():
...
// executando para cada elemento a instrução passada na 
// função operacaoNumerica.

// No dia a dia, a forma que utilizamos no vídeo é a mais usual. 
// Porém, durante seus estudos, você pode praticar da forma 
// que achar mais clara.
